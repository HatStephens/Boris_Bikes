...
describe DockingStation do
	...
	let (:the_station) {DockingStation.new(:capacity => 53)}
	let (:the_second_station) { DockingStation.new }

	it 'should be able to set a default capacity on initializing' do
...
# 		expect(the_station.available_bikes).to eq([working_bike])
# 	end
